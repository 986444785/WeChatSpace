...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back.png"]
                                                                             style:UIBarButtonItemStylePlain target:self action:@selector(clickBack)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //显示相薄名称+图片张数
    cell.textLabel.text = [NSString stringWithFormat:@"%@(%li张)",[group valueForProperty:ALAssetsGroupPropertyName],(long)[group numberOfAssets]];
    return cell;
}
